    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("My Owner(Creator) Join This Group 😱😍😱.")
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text("MY OWNER IS COMMING ON THIS GROUP 😱😱😱")
            ...
            # Welcome yourself
                ...
                update.effective_message.reply_text("THANKS FOR ADDING ME, JOIN OUR OFFICIAL CHANNEL : @NGY_CGS.")
